...
using StudentSystem.App.Utilities;
...
namespace StudentSystem.App
{
    ...
    {
        public static void AddCourses(int coursesCount, StudentSystemDbContext dbContext)
        {
        ...
        public static void AddStudents(int studentsCount, StudentSystemDbContext dbContext)
        {
